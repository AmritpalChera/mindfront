  ...
  if (forgotDone) {
    return (
      <div className="w-full h-screen flex flex-col items-center justify-center">
        <div className="text-xl text-primary">You will receive an email if you are in our system.</div>
        <div className="text-xl text-primary mt-2">Check your mailbox</div>
