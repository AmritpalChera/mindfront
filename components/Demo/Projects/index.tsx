    ...
    <div className="flex justify-center flex-col items-center pb-24">
      ...
      <div className="flex flex-col items-center justify-around md:px-24 mt-24 gap-12">
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-4 p-4">
          <div className=" mt-12 max-w-3xl flex shadow-xl border p-1 bg-gray-400 justify-center rounded-lg">
          <Image
        ...
        <div className="flex flex-wrap-reverse md:flex-nowrap items-center gap-4 p-4">
          <div className="text-3xl whitespace-pre-wrap">
              <h1 className="md:text-start text-center"><span className="text-4xl font-bold text-primary">Scroll DB collections with ease</span><br/><br/>Easily view and delete collections</h1>
            </div>
          <div className=" mt-12 max-w-3xl flex shadow-xl border p-1 bg-gray-400 justify-center rounded-lg">
            <Image
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-4 p-4">
          ...
          <div className="text-3xl whitespace-pre-wrap">
            <h1 className="md:text-start text-center"><span className="text-4xl font-bold text-primary">Search through collection vectors using the search bar.</span><br/><br/>Update data and delete vectors.</h1>
          </div>
        </div>
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-4 p-4">
          ...
          <div className="text-3xl whitespace-pre-wrap max-w-xl">
            <h1 className="md:text-start text-center">
              <span className="text-4xl font-bold text-primary">Test AI responses from uploaded data</span><br /><br />Test response quality instantly
            </h1>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-around md:px-24 mt-24 gap-12">
        ...
        <div className="flex flex-wrap-reverse md:flex-nowrap items-center gap-4 p-4">
          <div className="text-3xl whitespace-pre-wrap">
              <h1 className="md:text-start text-center"><span className="text-4xl font-bold text-primary">Automatic extraction of content</span><br/><br/>Store content from different sources without hassle</h1>
            </div>
          <div className=" mt-12 max-w-3xl flex shadow-xl border p-1 bg-gray-400 justify-center rounded-lg">
            <Image
      ...
      <div className="flex flex-col items-center justify-around md:px-24 mt-24 gap-12">
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-4 p-4">
          ...
          <div className="text-3xl whitespace-pre-wrap max-w-lg">
            <h1 className="md:text-start text-center"><span className="text-4xl font-bold text-primary">Search the web</span><br/><br/>Get select links for your search queries</h1>
          </div>
        </div>
