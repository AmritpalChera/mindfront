export default function ProjectsGrid({setActiveCollection}) {
  ...
  const projectCard = () => {
    return (
      <div className="w-64 rounded-xl border-2 border-gray-200 h-64 shadow-md shadow-gray flex flex-col p-4  dark:bg-secondary">
        ...
        <div className="text-gray-500 mt-3 gap-3 flex flex-col  flex-1">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mr-3">
            ...
            <span>Updated 23 June, 2023</span>
          </div>
        </div>
        <div>
          <div
            onClick={()=>setActiveCollection('ExperAI')}
